...
##########################################################
#### Experiments with Normals in increasing dimension ####
##########################################################
...
source("inst/mvnorm/mvnorm_scalingdimension.R") # creates scalingfixedn.RData and scalinglinearn.RData
source("inst/mvnorm/mvnorm_moreintermediatesteps.R") # creates scalingintermediate.RData (not necessary anymore)
source("inst/mvnorm/mvnorm_moreintermediatesteps_unbiased.R") # creates scalingintermediate.unbiased.RData
source("inst/mvnorm/mvnorm_plots.R") # creates the plots of Section S3 in the Supplementary Material

## -- side note
## A previous version of the arXiv draft had some genealogical trees, generated by the script trees/treeplots.R
## It requires igraph, ggraph.
